...
var _user$project$Model$countMatches = F4(
	function (selectedBallType, ball1, ball2, ball3) {
		return (_elm_lang$core$Native_Utils.eq(selectedBallType, ball1) && (_elm_lang$core$Native_Utils.eq(ball1, ball2) && _elm_lang$core$Native_Utils.eq(ball2, ball3))) ? 1 : 0;
	});
var _user$project$Model$countMultiPinPoints = F4(
	function (ball, _p2, _p1, _p0) {
		var _p3 = _p2;
		var _p10 = _p3._2;
		var _p9 = _p3._0;
		var _p4 = _p1;
		...
		var _p7 = _p5._2;
		var _p6 = _p5._0;
		return (((A4(_user$project$Model$countMatches, ball, _p9, _p4._0, _p6) + A4(_user$project$Model$countMatches, ball, _p3._1, _p8, _p5._1)) + A4(_user$project$Model$countMatches, ball, _p10, _p4._2, _p7)) + A4(_user$project$Model$countMatches, ball, _p9, _p8, _p7)) + A4(_user$project$Model$countMatches, ball, _p10, _p8, _p6);
	});
var _user$project$Model$countSinglePinPoints = F2(
	function (ball, _p11) {
		var _p12 = _p11;
		return A4(_user$project$Model$countMatches, ball, _p12._0, _p12._1, _p12._2);
	});
var _user$project$Model$currentScore = F2(
	function (ball, board) {
		return ((((((((((((A4(_user$project$Model$countMultiPinPoints, ball, board.zero, board.one, board.two) + A4(_user$project$Model$countMultiPinPoints, ball, board.zero, board.three, board.six)) + A4(_user$project$Model$countMultiPinPoints, ball, board.one, board.four, board.seven)) + A4(_user$project$Model$countMultiPinPoints, ball, board.one, board.three, board.five)) + A4(_user$project$Model$countMultiPinPoints, ball, board.two, board.four, board.six)) + A4(_user$project$Model$countMultiPinPoints, ball, board.five, board.six, board.seven)) + A2(_user$project$Model$countSinglePinPoints, ball, board.zero)) + A2(_user$project$Model$countSinglePinPoints, ball, board.one)) + A2(_user$project$Model$countSinglePinPoints, ball, board.two)) + A2(_user$project$Model$countSinglePinPoints, ball, board.three)) + A2(_user$project$Model$countSinglePinPoints, ball, board.four)) + A2(_user$project$Model$countSinglePinPoints, ball, board.five)) + A2(_user$project$Model$countSinglePinPoints, ball, board.six)) + A2(_user$project$Model$countSinglePinPoints, ball, board.seven);
	});
		...
		switch (_p13.ctor) {
			...
			case 'Red':
				return _elm_lang$core$Native_Utils.update(
					rack,
					{
						red: A2(_elm_lang$core$Basics$max, 0, rack.red - 1)
					});
			default:
				return _elm_lang$core$Native_Utils.update(
					rack,
					{
						white: A2(_elm_lang$core$Basics$max, 0, rack.white - 1)
					});
		}
	});
var _user$project$Model$initialRack = {red: 12, white: 12};
var _user$project$Model$getPin = F2(
	function (pinId, board) {
		var _p14 = pinId;
		switch (_p14.ctor) {
			case 'Zero':
				return board.zero;
...
var _user$project$Model$Model = F3(
	function (a, b, c) {
		return {board: a, rack: b, gameState: c};
	});
var _user$project$Model$Board = F8(
	function (a, b, c, d, e, f, g, h) {
		return {zero: a, one: b, two: c, three: d, four: e, five: f, six: g, seven: h};
	});
var _user$project$Model$Rack = F2(
	function (a, b) {
		return {red: a, white: b};
	});
...
var _user$project$Model$Seven = {ctor: 'Seven'};
var _user$project$Model$Six = {ctor: 'Six'};
var _user$project$Model$Five = {ctor: 'Five'};
var _user$project$Model$Four = {ctor: 'Four'};
var _user$project$Model$Three = {ctor: 'Three'};
var _user$project$Model$Two = {ctor: 'Two'};
var _user$project$Model$One = {ctor: 'One'};
var _user$project$Model$Zero = {ctor: 'Zero'};
var _user$project$Model$pinIdPossibilities = _elm_lang$core$Native_List.fromArray(
	[_user$project$Model$Zero, _user$project$Model$One, _user$project$Model$Two, _user$project$Model$Three, _user$project$Model$Four, _user$project$Model$Five, _user$project$Model$Six, _user$project$Model$Seven]);
var _user$project$Model$Pin = F3(
	function (a, b, c) {
		return {ctor: 'Pin', _0: a, _1: b, _2: c};
	});
var _user$project$Model$White = {ctor: 'White'};
var _user$project$Model$Red = {ctor: 'Red'};
var _user$project$Model$NoBall = {ctor: 'NoBall'};
var _user$project$Model$placeOnPin = F2(
	function (newBall, _p15) {
		var _p16 = _p15;
		var _p19 = _p16._2;
		var _p18 = _p16._1;
		var _p17 = _p16._0;
		return _elm_lang$core$Native_Utils.eq(_p17, _user$project$Model$NoBall) ? A3(_user$project$Model$Pin, newBall, _p18, _p19) : (_elm_lang$core$Native_Utils.eq(_p18, _user$project$Model$NoBall) ? A3(_user$project$Model$Pin, _p17, newBall, _p19) : (_elm_lang$core$Native_Utils.eq(_p19, _user$project$Model$NoBall) ? A3(_user$project$Model$Pin, _p17, _p18, newBall) : _p16));
	});
var _user$project$Model$place = F3(
	function (ball, pinId, board) {
		var _p20 = pinId;
		switch (_p20.ctor) {
			case 'Zero':
				return _elm_lang$core$Native_Utils.update(
					board,
					{
						zero: A2(_user$project$Model$placeOnPin, ball, board.zero)
					});
			case 'One':
				return _elm_lang$core$Native_Utils.update(
					board,
					{
						one: A2(_user$project$Model$placeOnPin, ball, board.one)
					});
			case 'Two':
				return _elm_lang$core$Native_Utils.update(
					board,
					{
						two: A2(_user$project$Model$placeOnPin, ball, board.two)
					});
			case 'Three':
				return _elm_lang$core$Native_Utils.update(
					board,
					{
						three: A2(_user$project$Model$placeOnPin, ball, board.three)
					});
			case 'Four':
				return _elm_lang$core$Native_Utils.update(
					board,
					{
						four: A2(_user$project$Model$placeOnPin, ball, board.four)
					});
			case 'Five':
				return _elm_lang$core$Native_Utils.update(
					board,
					{
						five: A2(_user$project$Model$placeOnPin, ball, board.five)
					});
			case 'Six':
				return _elm_lang$core$Native_Utils.update(
					board,
					{
						six: A2(_user$project$Model$placeOnPin, ball, board.six)
					});
			default:
				return _elm_lang$core$Native_Utils.update(
					board,
					{
						seven: A2(_user$project$Model$placeOnPin, ball, board.seven)
					});
		}
	});
var _user$project$Model$emptyPin = A3(_user$project$Model$Pin, _user$project$Model$NoBall, _user$project$Model$NoBall, _user$project$Model$NoBall);
var _user$project$Model$initialBoard = {zero: _user$project$Model$emptyPin, one: _user$project$Model$emptyPin, two: _user$project$Model$emptyPin, three: _user$project$Model$emptyPin, four: _user$project$Model$emptyPin, five: _user$project$Model$emptyPin, six: _user$project$Model$emptyPin, seven: _user$project$Model$emptyPin};
var _user$project$Model$defaultModel = {board: _user$project$Model$initialBoard, rack: _user$project$Model$initialRack, gameState: _user$project$Model$InProgress};
var _user$project$Model$pinHasRoom = function (_p21) {
	var _p22 = _p21;
	return _elm_lang$core$Native_Utils.eq(_p22._0, _user$project$Model$NoBall) || (_elm_lang$core$Native_Utils.eq(_p22._1, _user$project$Model$NoBall) || _elm_lang$core$Native_Utils.eq(_p22._2, _user$project$Model$NoBall));
};
var _user$project$Model$getAvailablePinIds = function (board) {
	return A2(
		_elm_lang$core$List$filter,
		function (pinId) {
			return _user$project$Model$pinHasRoom(
				A2(_user$project$Model$getPin, pinId, board));
		},
		_user$project$Model$pinIdPossibilities);
};
...
var _user$project$View$rackHeight = 600;
var _user$project$View$rackHeightString = _elm_lang$core$Basics$toString(_user$project$View$rackHeight);
var _user$project$View$rackWidth = 250;
var _user$project$View$rackWidthString = _elm_lang$core$Basics$toString(_user$project$View$rackWidth);
...
var _user$project$View$getPinPosition = F5(
	function (pinId, x, y, w, h) {
		var _p0 = pinId;
		switch (_p0.ctor) {
			case 'Zero':
				return {ctor: '_Tuple2', _0: ((w * 39) / 48) + x, _1: ((h * 6) / 96) + y};
			case 'One':
				return {ctor: '_Tuple2', _0: ((w * 22) / 24) + x, _1: ((h * 13) / 96) + y};
			case 'Two':
				return {ctor: '_Tuple2', _0: ((w * 49) / 48) + x, _1: ((h * 20) / 96) + y};
			case 'Three':
				return {ctor: '_Tuple2', _0: ((w * 7) / 12) + x, _1: (h / 6) + y};
			case 'Four':
				return {ctor: '_Tuple2', _0: ((w * 11) / 16) + x, _1: ((h * 23) / 96) + y};
			case 'Five':
				return {ctor: '_Tuple2', _0: ((w * 6) / 24) + x, _1: ((h * 19) / 96) + y};
			case 'Six':
				return {ctor: '_Tuple2', _0: ((w * 17) / 48) + x, _1: ((h * 26) / 96) + y};
			default:
				return {ctor: '_Tuple2', _0: ((w * 11) / 24) + x, _1: ((h * 33) / 96) + y};
		}
	});
var _user$project$View$renderLines = F4(
	function (x, y, w, h) {
		var _p1 = A5(_user$project$View$getPinPosition, _user$project$Model$Seven, x, y, w, h);
		var leftBottomX = _p1._0;
		var leftBottomY = _p1._1;
		var _p2 = A5(_user$project$View$getPinPosition, _user$project$Model$Six, x, y, w, h);
		var leftMiddleX = _p2._0;
		var leftMiddleY = _p2._1;
		var _p3 = A5(_user$project$View$getPinPosition, _user$project$Model$Five, x, y, w, h);
		var leftTopX = _p3._0;
		var leftTopY = _p3._1;
		var _p4 = A5(_user$project$View$getPinPosition, _user$project$Model$Two, x, y, w, h);
		var rightBottomX = _p4._0;
		var rightBottomY = _p4._1;
		var _p5 = A5(_user$project$View$getPinPosition, _user$project$Model$One, x, y, w, h);
		var rightMiddleX = _p5._0;
		var rightMiddleY = _p5._1;
		var _p6 = A5(_user$project$View$getPinPosition, _user$project$Model$Zero, x, y, w, h);
		var rightTopX = _p6._0;
		var rightTopY = _p6._1;
		return _elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(leftTopX),
								A2(
									_elm_lang$core$Basics_ops['++'],
									' ',
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(leftTopY),
										A2(
											_elm_lang$core$Basics_ops['++'],
											A2(
												_elm_lang$core$Basics_ops['++'],
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													_elm_lang$core$Basics$toString(rightMiddleX),
													A2(
														_elm_lang$core$Basics_ops['++'],
														' ',
														_elm_lang$core$Basics$toString(rightMiddleY)))),
											A2(
												_elm_lang$core$Basics_ops['++'],
												A2(
													_elm_lang$core$Basics_ops['++'],
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														_elm_lang$core$Basics$toString(leftBottomX),
														A2(
															_elm_lang$core$Basics_ops['++'],
															' ',
															_elm_lang$core$Basics$toString(leftBottomY)))),
												'Z')))))))
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(rightTopX),
								A2(
									_elm_lang$core$Basics_ops['++'],
									' ',
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(rightTopY),
										A2(
											_elm_lang$core$Basics_ops['++'],
											A2(
												_elm_lang$core$Basics_ops['++'],
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													_elm_lang$core$Basics$toString(leftMiddleX),
													A2(
														_elm_lang$core$Basics_ops['++'],
														' ',
														_elm_lang$core$Basics$toString(leftMiddleY)))),
											A2(
												_elm_lang$core$Basics_ops['++'],
												A2(
													_elm_lang$core$Basics_ops['++'],
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														_elm_lang$core$Basics$toString(rightBottomX),
														A2(
															_elm_lang$core$Basics_ops['++'],
															' ',
															_elm_lang$core$Basics$toString(rightBottomY)))),
												'Z')))))))
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
...
var _user$project$View$renderStand = F4(
	function (x, y, w, h) {
		return A2(
			_elm_lang$svg$Svg$g,
			_elm_lang$core$Native_List.fromArray(
			...
			A2(
				...
				A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg_Attributes$fill('#111111'),
							_elm_lang$svg$Svg_Attributes$d(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'M',
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(((w * 5) / 12) + x),
									A2(
										_elm_lang$core$Basics_ops['++'],
										' ',
										A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Basics$toString(((h * 5) / 48) + y),
											A2(
												_elm_lang$core$Basics_ops['++'],
												A2(
													_elm_lang$core$Basics_ops['++'],
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														_elm_lang$core$Basics$toString(((w * 5) / 6) + x),
														A2(
															_elm_lang$core$Basics_ops['++'],
															' ',
															A2(
																_elm_lang$core$Basics_ops['++'],
																_elm_lang$core$Basics$toString(0 + y),
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	' ',
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		_elm_lang$core$Basics$toString(((w * 25) / 24) + x),
																		A2(
																			_elm_lang$core$Basics_ops['++'],
																			' ',
																			_elm_lang$core$Basics$toString(((h * 5) / 48) + y)))))))),
													...
													A2(
														...
														A2(
															...
															A2(
																_elm_lang$core$Basics_ops['++'],
																' ',
																_elm_lang$core$Basics$toString(((h * 5) / 16) + y)))),
													A2(
														_elm_lang$core$Basics_ops['++'],
														A2(
															_elm_lang$core$Basics_ops['++'],
															...
															A2(
																_elm_lang$core$Basics_ops['++'],
																_elm_lang$core$Basics$toString(((w * 5) / 24) + x),
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	' ',
																	_elm_lang$core$Basics$toString(((h * 5) / 16) + y)))),
					...
					_elm_lang$core$Native_List.fromArray(
						[])),
				A4(_user$project$View$renderLines, x, y, w, h)));
	});
var _user$project$View$pinHeight = 100;
var _user$project$View$pinHeightString = _elm_lang$core$Basics$toString(_user$project$View$pinHeight);
var _user$project$View$ballRadius = _user$project$View$pinHeight / 5;
var _user$project$View$ballRadiusString = _elm_lang$core$Basics$toString(_user$project$View$ballRadius);
var _user$project$View$renderActualBall = F3(
	function (extraAttributes, xPos, yPos) {
		return A2(
			...
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$svg$Svg_Attributes$clipPath('url(#ballClip)'),
						...
						_elm_lang$svg$Svg_Attributes$r(_user$project$View$ballRadiusString)
					]),
				extraAttributes),
			_elm_lang$core$Native_List.fromArray(
				[]));
	});
var _user$project$View$renderBall = F3(
	function (ball, x, y) {
		var _p7 = ball;
		switch (_p7.ctor) {
			case 'NoBall':
			...
			case 'Red':
				return A3(
					_user$project$View$renderActualBall,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg_Attributes$fill('#FF4136')
						]),
					x,
					y);
			default:
...
var _user$project$View$renderBalls = function (rack) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		A2(
			_elm_lang$core$List$map,
			function (index) {
				return A3(_user$project$View$renderBall, _user$project$Model$Red, _user$project$View$rackWidth / 3, (_user$project$View$rackHeight * ((12 - index) - 0.5)) / 12);
			},
			_elm_lang$core$Native_List.range(
				0,
				_elm_lang$core$Basics$toFloat(rack.red) - 1)),
		A2(
			_elm_lang$core$List$map,
			function (index) {
				return A3(_user$project$View$renderBall, _user$project$Model$White, (_user$project$View$rackWidth * 2) / 3, (_user$project$View$rackHeight * ((12 - index) - 0.5)) / 12);
			},
			_elm_lang$core$Native_List.range(
				0,
				_elm_lang$core$Basics$toFloat(rack.white) - 1)));
};
var _user$project$View$renderRack = function (rack) {
	return A2(
		_elm_lang$svg$Svg$svg,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$width(_user$project$View$rackWidthString),
				_elm_lang$svg$Svg_Attributes$height(_user$project$View$rackHeightString),
				...
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$View$rackWidthString,
						A2(_elm_lang$core$Basics_ops['++'], ' ', _user$project$View$rackHeightString))))
			]),
		A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Native_List.fromArray(
			...
			_user$project$View$renderBalls(rack)));
};
var _user$project$View$halfPinWidth = 12.5;
var _user$project$View$halfPinWidthString = _elm_lang$core$Basics$toString(_user$project$View$halfPinWidth);
var _user$project$View$standH = _user$project$View$boardHeight;
var _user$project$View$standW = _user$project$View$boardWidth;
var _user$project$View$standY = _user$project$View$boardHeight / 3;
var _user$project$View$standX = (0 - _user$project$View$boardWidth) / 8;
var _user$project$View$stand = A4(_user$project$View$renderStand, _user$project$View$standX, _user$project$View$standY, _user$project$View$standW, _user$project$View$standH);
var _user$project$View$renderPin = F2(
	function (board, pinId) {
		var _p8 = A2(_user$project$Model$getPin, pinId, board);
		var pin = _p8;
		var bottom = _p8._0;
		var middle = _p8._1;
		var top = _p8._2;
		var pinExtraAttributes = _user$project$Model$pinHasRoom(pin) ? _elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Events$onClick(
				_user$project$Msg$Place(pinId))
			]) : _elm_lang$core$Native_List.fromArray(
			[]);
		var _p9 = A5(_user$project$View$getPinPosition, pinId, _user$project$View$standX, _user$project$View$standY, _user$project$View$standW, _user$project$View$standH);
		var baseX = _p9._0;
		var baseY = _p9._1;
		var topLeftCornerX = baseX - _user$project$View$halfPinWidth;
		var topLeftCornerY = (baseY - _user$project$View$pinHeight) + 3;
		return A2(
			_elm_lang$svg$Svg$g,
			_elm_lang$core$Native_List.fromArray(
				[]),
					...
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Basics$toString(topLeftCornerX)),
								_elm_lang$svg$Svg_Attributes$y(
								_elm_lang$core$Basics$toString(topLeftCornerY)),
								_elm_lang$svg$Svg_Attributes$width('25'),
								_elm_lang$svg$Svg_Attributes$height(_user$project$View$pinHeightString)
							])),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$svg$Svg_Attributes$fill('#888888'),
								_elm_lang$svg$Svg_Attributes$cx(
								_elm_lang$core$Basics$toString(baseX)),
								_elm_lang$svg$Svg_Attributes$cy(
								_elm_lang$core$Basics$toString(topLeftCornerY)),
								_elm_lang$svg$Svg_Attributes$r(_user$project$View$halfPinWidthString)
							])),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A3(_user$project$View$renderBall, bottom, baseX, baseY - (_user$project$View$pinHeight / 6)),
					A3(_user$project$View$renderBall, middle, baseX, baseY - (_user$project$View$pinHeight / 2)),
					A3(_user$project$View$renderBall, top, baseX, baseY - ((_user$project$View$pinHeight * 5) / 6))
				]));
	});
var _user$project$View$renderPins = function (board) {
	return A2(
		_elm_lang$core$List$map,
		_user$project$View$renderPin(board),
		_user$project$Model$pinIdPossibilities);
};
var _user$project$View$renderBoard = function (board) {
	return A2(
		_elm_lang$svg$Svg$g,
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(
			_elm_lang$core$List_ops['::'],
			_user$project$View$stand,
			_user$project$View$renderPins(board)));
};
var _user$project$View$gameStateToString = function (model) {
	var userScore = _elm_lang$core$Basics$toString(
		A2(_user$project$Model$currentScore, _user$project$Model$White, model.board));
	var cpuScore = _elm_lang$core$Basics$toString(
		A2(_user$project$Model$currentScore, _user$project$Model$Red, model.board));
		...
		case 'Win':
			return A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					userScore,
					A2(_elm_lang$core$Basics_ops['++'], ' to ', cpuScore)));
		case 'Loss':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'You lost ',
		...
		default:
			return A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					cpuScore,
					A2(_elm_lang$core$Basics_ops['++'], ' -  You : ', userScore)));
	}
};
				...
				A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_user$project$View$renderRack(_p13.rack)
								])),
							A2(
							_debois$elm_mdl$Material_Grid$cell,
							_elm_lang$core$Native_List.fromArray(
								...
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_user$project$View$gameStateToString(_p13))
										])),
									A2(
									_elm_lang$svg$Svg$svg,
									_elm_lang$core$Native_List.fromArray(
										...
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													...
													_elm_lang$core$Native_List.fromArray(
														[
															_elm_lang$svg$Svg_Attributes$id('ballClip'),
															_elm_lang$svg$Svg_Attributes$clipPathUnits('objectBoundingBox')
														]),
													_elm_lang$core$Native_List.fromArray(
														[
															A2(
															...
															_elm_lang$core$Native_List.fromArray(
																[
																	_elm_lang$svg$Svg_Attributes$x('0'),
																	_elm_lang$svg$Svg_Attributes$y('0.125'),
																	_elm_lang$svg$Svg_Attributes$width('1'),
																	_elm_lang$svg$Svg_Attributes$height('0.75')
																]),
															_elm_lang$core$Native_List.fromArray(
																[]))
														]))
												])),
											_user$project$View$renderBoard(_p13.board)
										]))
								]))
						])))
			]));
...
var _user$project$Update$applyMove = F2(
	function (model, _p0) {
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				board: A3(_user$project$Model$place, _p1._0, _p1._1, model.board)
			});
	});
var _user$project$Update$isScoreIncreasingMove = F3(
	function (ball, model, move) {
		var newScore = A2(
			_user$project$Model$currentScore,
			ball,
			A2(_user$project$Update$applyMove, model, move).board);
		var oldScore = A2(_user$project$Model$currentScore, ball, model.board);
		return _elm_lang$core$Native_Utils.cmp(newScore, oldScore) > 0;
	});
var _user$project$Update$userScoreIncreasingMove = _user$project$Update$isScoreIncreasingMove(_user$project$Model$White);
var _user$project$Update$cpuScoreIncreasingMove = _user$project$Update$isScoreIncreasingMove(_user$project$Model$Red);
var _user$project$Update$isTieModel = function (model) {
	var rack = model.rack;
	return ((_elm_lang$core$Native_Utils.cmp(rack.red, 0) < 1) && (_elm_lang$core$Native_Utils.cmp(rack.white, 0) < 1)) ? _elm_lang$core$Native_Utils.eq(
		A2(_user$project$Model$currentScore, _user$project$Model$White, model.board),
		A2(_user$project$Model$currentScore, _user$project$Model$Red, model.board)) : false;
};
var _user$project$Update$isUserLosingModel = function (model) {
	var rack = model.rack;
	return ((_elm_lang$core$Native_Utils.cmp(rack.red, 0) < 1) && (_elm_lang$core$Native_Utils.cmp(rack.white, 0) < 1)) ? (_elm_lang$core$Native_Utils.cmp(
		A2(_user$project$Model$currentScore, _user$project$Model$White, model.board),
		A2(_user$project$Model$currentScore, _user$project$Model$Red, model.board)) < 1) : false;
};
...
var _user$project$Update$isCPULosingModel = function (model) {
	...
	return ((_elm_lang$core$Native_Utils.cmp(rack.red, 0) < 1) && (_elm_lang$core$Native_Utils.cmp(rack.white, 0) < 1)) ? (_elm_lang$core$Native_Utils.cmp(
		A2(_user$project$Model$currentScore, _user$project$Model$Red, model.board),
		A2(_user$project$Model$currentScore, _user$project$Model$White, model.board)) < 1) : false;
};
...
var _user$project$Update$getMoves = F3(
	function (ball, rack, board) {
		return A2(
			...
			A2(
				...
				_user$project$Model$getAvailablePinIds(board)));
	});
var _user$project$Update$nextPlayerHasNoWinningMove = F2(
	function (model, move) {
		var potentialModel = A2(_user$project$Update$applyMove, model, move);
		var potentialFutureMoves = A3(_user$project$Update$getMoves, _user$project$Model$White, model.rack, potentialModel.board);
		var _p2 = A2(
...
var _user$project$Update$nextPlayerHasNoScoreIncreasingMove = F2(
	function (model, move) {
		var potentialModel = A2(_user$project$Update$applyMove, model, move);
		var potentialFutureMoves = A3(_user$project$Update$getMoves, _user$project$Model$White, model.rack, potentialModel.board);
		var _p3 = A2(
			_user$project$Extras$find,
			_user$project$Update$userScoreIncreasingMove(potentialModel),
			potentialFutureMoves);
		if (_p3.ctor === 'Just') {
			return false;
		} else {
...
var _user$project$Update$cpuTurn = function (model) {
	var moves = A3(_user$project$Update$getMoves, _user$project$Model$Red, model.rack, model.board);
				...
				A2(
					...
					A2(
						...
						function (_p8) {
							...
							return A2(
								_user$project$Extras$find,
								_user$project$Update$nextPlayerHasNoScoreIncreasingMove(model),
								moves);
						},
						A2(
							_user$project$Extras$orElseLazy,
							function (_p10) {
								...
								return A2(
									_user$project$Extras$find,
									_user$project$Update$cpuScoreIncreasingMove(model),
									moves);
							},
							A2(
								_user$project$Extras$find,
								...
								moves)))))));
	var postRackUpdateModel = _elm_lang$core$Native_Utils.update(
		postMovementModel,
		{
			rack: A2(_user$project$Model$removeFromRack, _user$project$Model$Red, postMovementModel.rack)
		});
	return _user$project$Update$isCPULosingModel(postRackUpdateModel) ? _elm_lang$core$Native_Utils.update(
		postRackUpdateModel,
		{gameState: _user$project$Model$Win}) : (_user$project$Update$isUserLosingModel(postRackUpdateModel) ? _elm_lang$core$Native_Utils.update(
		postRackUpdateModel,
		{gameState: _user$project$Model$Loss}) : (_user$project$Update$isTieModel(postRackUpdateModel) ? _elm_lang$core$Native_Utils.update(
		postRackUpdateModel,
		{gameState: _user$project$Model$Tie}) : postRackUpdateModel));
};
var _user$project$Update$update = F2(
	function (msg, model) {
		var _p12 = msg;
		if (_p12.ctor === 'NewGame') {
			...
			if (_elm_lang$core$Native_Utils.eq(model.gameState, _user$project$Model$InProgress)) {
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						board: A3(_user$project$Model$place, _user$project$Model$White, _p12._0, model.board),
						rack: A2(_user$project$Model$removeFromRack, _user$project$Model$White, model.rack)
					});
				return _user$project$Update$isCPULosingModel(newModel) ? {
					...
					_1: _elm_lang$core$Platform_Cmd$none
				} : (_user$project$Update$isTieModel(newModel) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						newModel,
						{gameState: _user$project$Model$Tie}),
					_1: _elm_lang$core$Platform_Cmd$none
				} : {
					ctor: '_Tuple2',
...
var _user$project$Eclipse$subscriptions = _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none);
var _user$project$Eclipse$init = {ctor: '_Tuple2', _0: _user$project$MaterialModel$defaultState, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Eclipse$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Eclipse$init, update: _user$project$MaterialUpdate$materialUpdate, subscriptions: _user$project$Eclipse$subscriptions, view: _user$project$View$view})
};

var Elm = {};
Elm['Eclipse'] = Elm['Eclipse'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Eclipse'], 'Eclipse', typeof _user$project$Eclipse$main === 'undefined' ? null : _user$project$Eclipse$main);
